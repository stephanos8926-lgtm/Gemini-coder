    ...
    <div className="flex flex-col h-full w-full overflow-hidden bg-[#1e1e1e] relative">
      ...
      {showSidebar && (
        <>
          ...
          />
          <aside className="fixed top-0 left-0 bottom-0 w-[85vw] max-w-sm bg-[#1e1e1e] border-r border-[#3c3c3c] text-white z-[110] shadow-2xl overflow-hidden flex flex-col animate-in slide-in-from-left">
