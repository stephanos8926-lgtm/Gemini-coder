...
export const AuthGuard: React.FC<AuthGuardProps> = ({
  ...
  if (user && !isAuthLoading && isWorkspacesLoading && !showWorkspaceModal) {
    return (
      <div className="absolute inset-0 z-[100] flex items-center justify-center bg-[#1e1e1e]/90 backdrop-blur-md">
  ...
  if (user && !isAuthLoading && isWorkspacesError && !showWorkspaceModal) {
    return (
      <div className="absolute inset-0 z-[100] flex items-center justify-center bg-[#1e1e1e]/90 backdrop-blur-md">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
  ...
  if (user && !isAuthLoading && !isWorkspacesLoading && !isWorkspacesError && idToken && workspaces.length === 0 && !workspaceName && !showWorkspaceModal) {
    return (
      <div className="absolute inset-0 z-[100] flex items-center justify-center bg-[#1e1e1e]/90 backdrop-blur-md">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
  ...
  if (user && !isAuthLoading && !isWorkspacesLoading && idToken && workspaces.length > 0 && !workspaceName && !showWorkspaceModal) {
    return (
      <div className="absolute inset-0 z-[100] flex items-center justify-center bg-[#1e1e1e]/90 backdrop-blur-md">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
