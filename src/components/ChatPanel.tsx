...
renderer.code = ({ text, lang }: { text: string; lang?: string }) => {
  ...
  return `
    <div class="code-block-wrapper relative group my-4 rounded-lg overflow-hidden border border-border-subtle bg-[#0d0d0d]" data-large="${isLarge}">
      <div class="flex items-center justify-between px-3 py-1.5 bg-surface-card border-b border-border-subtle">
        ...
        <button class="copy-btn p-1 hover:bg-surface-accent rounded transition-colors focus-visible:ring-2 focus-visible:ring-accent-intel focus:outline-none" aria-label="Copy code" data-code="${encodeURIComponent(text)}">
      ...
      ${isLarge ? `
        <button class="expand-btn absolute bottom-0 left-0 right-0 py-2 bg-gradient-to-t from-[#0d0d0d] to-transparent text-[10px] font-bold text-accent-intel hover:text-accent-intel/80 transition-all flex items-center justify-center gap-1 focus-visible:ring-2 focus-visible:ring-accent-intel focus:outline-none" aria-label="Show more code">
          <span>Show More</span>
        </button>
      ` : ''}
    </div>
    ...
    <div className="flex flex-col h-full w-full overflow-hidden bg-surface-base border-r border-border-subtle">
      ...
      <div className="p-4 bg-transparent shrink-0">
        <div className="max-w-3xl mx-auto mb-2 flex items-center justify-between">
          <div className="flex items-center gap-2">
            {agents.length > 0 && (
              <div className="flex items-center gap-1.5 px-2 py-1 bg-surface-card border border-border-subtle rounded-md transition-all focus-within:ring-1 focus-within:ring-accent-intel/30">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1 bg-accent-intel/10 hover:bg-accent-intel/20 text-accent-intel border border-accent-intel/30 rounded-full text-[10px] font-bold uppercase tracking-wider focus-visible:ring-2 focus-visible:ring-accent-intel focus:outline-none transition-all"
          >
        ...
        <form onSubmit={handleSubmit} className="relative group max-w-3xl mx-auto">
          ...
          <div className="relative flex items-end bg-surface-card border border-border-subtle rounded-2xl focus-within:border-accent-primary focus-within:ring-1 focus-within:ring-accent-primary/20 transition-all shadow-lg">
            ...
            <button
              ...
              className={`absolute right-2 bottom-2 p-2 rounded-xl transition-all focus-visible:ring-2 focus-visible:ring-accent-intel focus:outline-none ${
