...
import { Settings as SettingsIcon, X, Monitor, Cpu, Layout, Save, RotateCcw, Type, Code, Terminal, Sparkles, User, Palette, Zap } from 'lucide-react';
...
type Tab = 'profile' | 'editor' | 'ai' | 'ui' | 'workspace';
