  ...
  <div className="mt-5 p-4 bg-[#1e1e1e] border border-[#3c3c3c] rounded-xl shadow-inner">
    ...
    <div className="flex flex-wrap gap-2">
      <button
        ...
        className="flex-1 sm:flex-none px-4 py-2 bg-accent-intel text-white rounded-lg hover:bg-accent-intel/80 transition-all text-xs font-bold shadow-lg shadow-accent-intel/20 disabled:opacity-50"
      >
        Yes, proceed
      </button>
      <button
