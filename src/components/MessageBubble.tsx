...
const ThinkingBlock = ({ thinking, taskList, expanded, setExpanded }: any) => (
  <div className="w-full space-y-2 my-2">
    ...
    <div className="border-l-2 border-accent-intel/30 pl-3 py-1">
      <button
        onClick={setExpanded}
        className="flex items-center gap-2 mb-1 opacity-60 hover:opacity-100 transition-opacity focus-visible:ring-1 focus-visible:ring-accent-intel outline-none rounded px-1"
  ...
  <div className="mt-5 p-4 bg-surface-base border border-border-subtle rounded-xl shadow-inner">
    ...
    <div className="flex flex-wrap gap-2">
      ...
      <button
        ...
        className="flex-1 sm:flex-none px-4 py-2 bg-transparent text-text-primary border border-border-subtle rounded-lg hover:bg-surface-card transition-all text-xs font-bold disabled:opacity-50 focus-visible:ring-2 focus-visible:ring-accent-intel outline-none"
      >
        No, cancel
      </button>
    </div>
