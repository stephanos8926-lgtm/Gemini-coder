  ...
  <div className="w-full space-y-2 my-2">
    ...
    <div className="border-l-2 border-accent-intel/30 pl-3 py-1">
      <button
        ...
        className="flex items-center gap-2 mb-1 opacity-60 hover:opacity-100 transition-opacity focus-visible:ring-1 focus-visible:ring-accent-intel outline-none rounded"
      >
    ...
    {responses.map((res: any, idx: number) => {
      ...
      return (
        <div key={`resp-${idx}-${res.name}`} className={`bg-surface-base border ${isError ? 'border-accent-security/20' : 'border-border-subtle'} rounded-lg overflow-hidden shadow-sm`}>
          ...
          <div className={`text-[11px] font-mono overflow-x-auto whitespace-pre-wrap break-all p-3 bg-black/10 ${isError ? 'text-accent-security' : 'text-text-primary'}`}>
