    ...
    <header className="h-12 border-b border-border-subtle bg-surface-card flex items-center justify-between px-4 shrink-0 z-50">
      <div className="flex items-center gap-4">
        <button
          ...
          className={`hidden sm:flex p-2 rounded-md transition-all focus-visible:ring-2 focus-visible:ring-accent-intel focus:outline-none ${isLeftSidebarOpen ? 'text-accent-intel bg-surface-base' : 'text-text-subtle hover:text-white'}`}
      ...
      <div className="flex items-center gap-1 sm:gap-3">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className="p-2 text-text-subtle hover:text-text-primary hover:bg-surface-accent rounded-md transition-all focus-visible:ring-2 focus-visible:ring-accent-intel focus:outline-none"
            title="Save All"
            aria-label="Save All"
          >
          ...
          <button
            ...
            className={`hidden sm:flex p-2 rounded-md transition-all focus-visible:ring-2 focus-visible:ring-accent-intel focus:outline-none ${isRightSidebarOpen ? 'text-accent-intel bg-surface-base' : 'text-text-subtle hover:text-white'}`}
